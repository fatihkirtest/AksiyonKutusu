...
namespace oyun_alim_takas
{
    ...
    {
        SqlConnection connect = new SqlConnection("Data Source=FATIH-MONSTER\\SQLEXPRESS;Initial Catalog=proje1;Integrated Security=true");
        int i = 0;
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while (i < a.Length)
                        {
                            if ((i + 1) == a.Length)//i +1 a nın lenght ine esitse keser..
                                break;
